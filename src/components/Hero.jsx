    ...
    >
      ...
      >
        ...
        <div className={`flex gap-3 mt-8 ${isSticky ? "mt-0" : ""}`}>
          <a
            href="#proyectos"
            className="flex items-center gap-1 bg-sky-600 hover:bg-sky-700 text-white px-2 py-2 rounded-md transition-all hover:scale-105"
          >
            <Code size={12} />
            <span>Proyectos</span>2
          </a>
          <a
            href="#cv"
            className="flex items-center gap-1 bg-transparent border-2 border-sky-600 text-sky-400 hover:bg-sky-900/30 px-2 py-2 rounded-md transition-all hover:scale-105"
          >
            <FileText size={12} />
          ...
          <a
            ...
            className="flex items-center gap-1 bg-transparent border-2 border-slate-600 text-slate-300 hover:bg-slate-800 px-2 py-2 rounded-md transition-all hover:scale-105"
          >
            <Github size={12} />
