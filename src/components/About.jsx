    ...
    return (
      <section id="about" className="p-10 text-center bg-gradient-to-b from-black to-gray-900 rounded-xl shadow-lg max-w-3xl mx-auto">
        ...
        <p className="text-lg text-gray-300 leading-relaxed">
          Soy <span className="text-slate-400 font-semibold">Nicolás Cabrera</span>, <span className="text-slate-400 font-semibold">desarrollador web</span> y <span className="text-slate-400 font-semibold">Reparador de PC's</span>. <br /><br />
